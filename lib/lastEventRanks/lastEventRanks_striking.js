...
//totals ranks
export async function getSignificantStrikesRank_LastEvent(prisma) {
...
export async function getDistanceStrikesRank_LastEvent(prisma) {
...
export async function getHeadStrikesRank_LastEvent(prisma) {
    const rank = await prisma.$queryRaw
        `
        SELECT aux.*, fighters.name as opponent_name
        FROM    
...
export async function getBodyStrikesRank_LastEvent(prisma) {
    const rank = await prisma.$queryRaw
        `
        SELECT aux.*, fighters.name as opponent_name
        FROM    
...
export async function getLegStrikesRank_LastEvent(prisma) {
    const rank = await prisma.$queryRaw
        `
        SELECT aux.*, fighters.name as opponent_name
        FROM    
...
export async function getKnockdownsRank_LastEvent(prisma) {
    const rank = await prisma.$queryRaw
        `
        SELECT aux.*, fighters.name as opponent_name
        FROM    
...
//per minute ranks
export async function getSignificantStrikesPerMinuteRank_LastEvent(prisma) {
...
export async function getDistanceStrikesPerMinuteRank_LastEvent(prisma) {
...
export async function getHeadStrikesPerMinuteRank_LastEvent(prisma) {
...
export async function getBodyStrikesPerMinuteRank_LastEvent(prisma) {
...
export async function getLegStrikesPerMinuteRank_LastEvent(prisma) {
