...
async function getFastestFinishesRank_LastEvent(prisma) {
...
async function getControlRank_LastEvent(prisma) {
    const rank = await prisma.$queryRaw
        `
        SELECT aux.*, fighters.name as opponent_name
        FROM    
...
async function getControlPerTakedownRank_LastEvent(prisma) {
