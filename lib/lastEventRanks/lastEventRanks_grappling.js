...
export async function getTakedownsRank_LastEvent(prisma) {
...
export async function getTakedownAccuracyRank_LastEvent(prisma) {
    const rank = await prisma.$queryRaw
        `
        SELECT aux.*, fighters.name as opponent_name
        FROM    
...
export async function getTakedownsDefendedRank_LastEvent(prisma) {
    const rank = await prisma.$queryRaw
        `
...
export async function getTakedownDefenceRank_LastEvent(prisma) {
    const rank = await prisma.$queryRaw
        `
        SELECT aux.*, fighters.name as fighter_name
        FROM    
...
export async function getSubAttemptsRank_LastEvent(prisma) {
    const rank = await prisma.$queryRaw
        `
        SELECT aux.*, fighters.name as opponent_name
        FROM    
...
export async function getGroundStrikesPerMinuteRank_LastEvent(prisma) {
...
export async function getTakedownsPerMinuteRank_LastEvent(prisma) {
